...
function Videocard({card,handleDeleteStatus,insideCategory}) {
  ...
  return (
      ...
      <Card.Body>
        <Card.Title>
            ...
            {card?.caption}
                ...
                {
                  insideCategory?"" :
                  < Trash2 onClick={()=>removeItem(card?.id)} color='black' style={{float:'right'}} />
                  }
        </Card.Title>
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <iframe width="100%" height="495" src={`${card?.url}?autoplay=1`} title="Full Video: Galliyan Song | Ek Villain | Ankit Tiwari | Sidharth Malhotra | Shraddha Kapoor" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
